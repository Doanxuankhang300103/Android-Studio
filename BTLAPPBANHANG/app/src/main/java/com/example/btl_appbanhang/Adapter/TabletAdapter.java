...
public class TabletAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TabletAdapter(Context context, List<SanPhamMoi> array) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myViewHolder.giasp.setText("Giá: " + sanPham.getGiasp() + " VNĐ");
    ...
    // ViewHolder cho item máy tính bảng
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itemtb_ten);
            giasp = itemView.findViewById(R.id.itemtb_gia);
            mota = itemView.findViewById(R.id.itemtb_mota);
            hinhanh = itemView.findViewById(R.id.itemtb_hinhanh);
    ...
    // ViewHolder cho ProgressBar khi loading
    ...
    public void updateList(List<SanPhamMoi> newList) {
        array.clear();
