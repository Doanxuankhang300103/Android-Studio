...
public class DienthoaiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    // Chỉ cần một phương thức onBindViewHolder
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            ((MyViewHolder) holder).tensp.setText(sanPham.getTensp());
            ((MyViewHolder) holder).giasp.setText("Giá: " + sanPham.getGiasp() + " VNĐ");
            ((MyViewHolder) holder).mota.setText(sanPham.getMota());
...
//                        Log.d(TAG, "onClick: " + sanPham.getId());
    ...
    // ViewHolder cho item điện thoại
